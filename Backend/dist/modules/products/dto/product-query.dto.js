...
class ProductQueryDto extends pagination_dto_1.PaginationDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { search: { required: false, type: () => String }, status: { required: false, type: () => [Object] }, categoryId: { required: false, type: () => String }, featured: { required: false, type: () => Boolean }, hasVariants: { required: false, type: () => Boolean } };
    }
}
exports.ProductQueryDto = ProductQueryDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Busca en nombre, descripción y SKU.' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ProductQueryDto.prototype, "search", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.ProductStatus, isArray: true, description: 'Coma-separado.' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], ProductQueryDto.prototype, "hasVariants", void 0);

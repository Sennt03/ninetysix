...
let UserMongooseRepository = class UserMongooseRepository {
    constructor(model) {
        this.model = model;
    }
    async create(data) {
        const created = await this.model.create({
            ...
            roles: data.roles ?? [role_enum_1.Role.USER],
        });
...
exports.UserMongooseRepository = UserMongooseRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(user_schema_1.User.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], UserMongooseRepository);
//# sourceMappingURL=user.mongoose.repository.js.map